...
| SR-09 | Cannot restore directly from a shared and encrypted RDS snapshot in a cross-account scenario | [Restoring from Snapshot](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_RestoreFromSnapshot.html) | Must copy snapshot first, then restore — adds time |
