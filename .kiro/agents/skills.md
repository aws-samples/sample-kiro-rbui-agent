...
| KT-03 | Exceeding KMS quota returns ThrottlingException — restore operations may stall or fail |[KMS ThrottlingException](https://repost.aws/knowledge-center/kms-throttlingexception-error) |[Resolve Amazon Aurora MySQL snapshot restore issues - AWS re:Post](https://repost.aws/knowledge-center/aurora-mysql-cluster-restore)|
